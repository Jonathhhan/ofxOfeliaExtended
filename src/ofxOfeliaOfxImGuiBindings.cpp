...
#define SWIG_name      "ofxImGui"
#define SWIG_init      luaopen_ofxImGui
#define SWIG_init_user luaopen_ofxImGui_user

#define SWIG_LUACODE   luaopen_ofxImGui_luacode
...
static int _wrap_Gui_begin(lua_State* L) { { int SWIG_arg = 0; ofxImGui::Gui *arg1 = (ofxImGui::Gui *) 0 ;
    ...
    if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ofxImGui__Gui,0))){
      SWIG_fail_ptr("Gui_begin",1,SWIGTYPE_p_ofxImGui__Gui); }  (arg1)->begin(); return SWIG_arg; fail: SWIGUNUSED; } 
  lua_error(L); return 0; }
static int _wrap_Gui_c_end(lua_State* L) { { int SWIG_arg = 0; ofxImGui::Gui *arg1 = (ofxImGui::Gui *) 0 ;
    SWIG_check_num_args("ofxImGui::Gui::end",1,1)
    if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("ofxImGui::Gui::end",1,"ofxImGui::Gui *");
    if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ofxImGui__Gui,0))){
      SWIG_fail_ptr("Gui_c_end",1,SWIGTYPE_p_ofxImGui__Gui); }  (arg1)->end(); return SWIG_arg; fail: SWIGUNUSED; } 
  lua_error(L); return 0; }
